...
app.view = function (ctrl) {
	...
	m(".jumbotron", [
		...
		m("p", [
            [m("a.btn.btn-primary.btn-lg[href='#'][id='yes'][onclick='showNotification(\'YES!!\', \'Just a Test\', \'Success\', 5000, notificationRightPos, notificationTopPos, null);']", "Yes"), "\n", m("a.btn.btn-primary.btn-lg[href='#'][id='no'][onclick='showNotification(\'NO!!\', \'Just a Test\', \'Error\', 5000, notificationRightPos, notificationTopPos, null);']", "No"), "\n", m("a.btn.btn-primary.btn-lg[href='#'][id='maybe'][onclick='showNotification(\'MAYBE SO...\', \'Just a Test\', \'Warning\', 5000, notificationRightPos, notificationTopPos, null);']", "Maybe So")]
		])
	]),
	m(".row", [
		m(".col-md-4", [
